...
const config: Config = {
	...
	projectName: 'jetup', // Usually your repo name.
		...
		[
			'classic',
			{
				docs: {
					...
					editUrl: 'https://github.com/aldhosutra/jetup/',
				},
				blog: {
	...
	themeConfig: {
		...
		navbar: {
			...
			items: [
				...
				{
					href: 'https://github.com/aldhosutra/jetup',
					label: 'GitHub',
					position: 'right',
				},
			],
			...
			links: [
				...
				},
				{
					...
					items: [
						{
							label: 'npm',
							href: 'https://npmjs.com/package/jetup',
						},
						{
							label: 'GitHub',
							href: 'https://github.com/aldhosutra/jetup',
